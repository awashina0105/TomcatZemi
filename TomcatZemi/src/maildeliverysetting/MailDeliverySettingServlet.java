...
public class MailDeliverySettingServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (StringUtils.isEmpty(studentId)) {
			...
			int categoryId2 = mdsbean.getCategoryId1();
			int categoryId3 = mdsbean.getCategoryId1();
			int categoryId4 = mdsbean.getCategoryId1();
			int categoryId5 = mdsbean.getCategoryId1();

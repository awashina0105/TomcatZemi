       ...
       //propsに設定した情報を使用して、sessionの作成
        final Session session = Session.getInstance(props, new Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("mikageyue@gmail.com", "mpdx8758");
            }
        });
        ...
        try {
            final Address addrFrom = new InternetAddress(
                    "mikageyue@gmail.com", "テスト西田井", ENCODE);
            message.setFrom(addrFrom);

            final Address addrTo = new InternetAddress("suzuneandmisato1129@gmail.com",
                    "テスト受信西田井", ENCODE);
